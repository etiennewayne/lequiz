                ...
                <div class="card-body">
                    <form method="POST" action="/account/{{$user->user_id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mname" type="text" class="form-control @error('mname') is-invalid @enderror" name="mname" value="{{ $user->mname }}" autocomplete="off" autofocus>
                                @error('mname')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="classification" class="form-control">
                                    ...
                                    @if($user->classification == 'FACULTY')
                                        <option selected="selected" value="{{ $user->classification }}">{{ $user->classification }}</option>
                                        <option value="STUDENT">STUDENT</option>
                                    @elseif($user->classification == 'STUDENT')
                                        <option selected="selected" value="{{ $user->classification }}">{{ $user->classification }}</option>
